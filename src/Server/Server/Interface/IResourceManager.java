...
public interface IResourceManager extends Remote {
     ...
     * possible to add seats to an existing flight. Adding to an existing flight
     * should overwrite the current price of the available seats.
     *
     * @return Success
     */
     ...
     * Delete the flight.
     *
     * deleteFlight implies whole deletion of the flight. If there is a reservation
     * on the flight, then the flight cannot be deleted
     *
     * @return Success
     */
