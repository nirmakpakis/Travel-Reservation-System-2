				...
				synchronized (this.lockTable) {
					...
					if (!bConflict) {
						...
						if (bConvert.get(0) == true) {
							...
							TransactionLockObject xLockObjectRead = new TransactionLockObject(xid, data,
									TransactionLockObject.LockType.LOCK_READ);
							DataLockObject dataLockObjectRead = new DataLockObject(xid, data,
									TransactionLockObject.LockType.LOCK_READ);
